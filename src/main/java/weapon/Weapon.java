...
public abstract class Weapon {
     ...
     * @param t3 右向换弹中纹理
     */
    public Weapon(Bullet bullet, int velocity, int damage, int interval, Texture t0, Texture t1, Texture t2, Texture t3, File shootSoundEffect) {
        this.bullet = bullet;
    ...
    public Weapon(Weapon another) {
        this(new Bullet(another.bullet), another.velocity, another.damage, another.interval, another.textures[0], another.textures[1], another.textures[2], another.textures[3], another.shootSoundEffect);
    }
     ...
     * @return 射击音效
     */
    public File getShootSoundEffect() {
